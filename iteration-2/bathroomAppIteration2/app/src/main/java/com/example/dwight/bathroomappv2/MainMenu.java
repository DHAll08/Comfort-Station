...
public class MainMenu extends AppCompatActivity {
    ...
    public DBHandler createDB()
    {
        ...
        db.addRoom(new Room(3122,"313","L","1",2116));
        ...
        //Behavioral & Social Sciences
        db.addCompLab(new CompLab(4122,313,3122));
        db.addCompLab(new CompLab(4123,317,3123));

        //Library
        db.addCompLab(new CompLab(4155,121,3155));
        db.addCompLab(new CompLab(4156,122,3156));
        db.addCompLab(new CompLab(4157,120,3157));
        db.addCompLab(new CompLab(4160,205,3160));
