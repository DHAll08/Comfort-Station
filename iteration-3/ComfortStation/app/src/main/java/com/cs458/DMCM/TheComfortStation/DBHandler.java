...
public class DBHandler extends SQLiteOpenHelper
{
    ...
    */
    ...
    public List<Building> getAllBuildings()
    {
        ...
        String selectQuery = "SELECT * FROM " + TABLE_BUILDINGS + " ORDER BY " + BUILD_NAME;
        SQLiteDatabase db = this.getWritableDatabase();
   ...
   */
    ...
    */
    ...
    /*
        - Query basic computer info - floor, room, and # of computers
        - Store query info as CompBasic (Basic Computer Lab) objects in an array list.
    */

    public String[] getCompBasics(String build_name)
    {
        List<CompBasic> compList = new ArrayList<>();
        String selectQuery = "SELECT DISTINCT " + FLOOR_NUM + ", " + ROOM_NUM + ", " + COMP_NUM + " FROM  " + TABLE_COMPLABS + "," + TABLE_ROOMS + "," + TABLE_FLOORS + "," + TABLE_BUILDINGS +
        ...
        if(cursor.moveToFirst())
        {
            do
            {
                CompBasic room = new CompBasic(cursor.getString(0),cursor.getString(1),cursor.getString(2));
                compList.add(room);
            }
            while (cursor.moveToNext());
        }
    ...
    /*
        - Traverse through the array list of CompBasic objects.
        - Fill list with Strings containing floor num, room num, and number of computers for every
            computer lab. (gathered from the "get" methods of the CompBasic objects)
        - return this list for populating ListView in AmenityList Activity (ie page)
    */
    ...
    */
    ...
    public String[] getCompExtras(String build_name)
    {
        List<CompBasic> compList = new ArrayList<>();
        String selectQuery = "SELECT DISTINCT " + FLOOR_NUM + ", " + ROOM_NUM + ", " + COMP_NUM + " FROM  " + TABLE_COMPLABS + "," + TABLE_ROOMS + "," + TABLE_FLOORS + "," + TABLE_BUILDINGS +
                " WHERE " + TABLE_COMPLABS + "." + ROOM_ID + " = " + TABLE_ROOMS + "." + ROOM_ID + " AND "
    ...
    */
        ...
        for(int counter=0; counter < compList.size(); counter++)
        {
            String info = compList.get(counter).getCompNum();
            computerList[counter]= info;
        }
